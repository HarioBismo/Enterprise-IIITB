...
<html>
    ...
    <div id="home" class="tab-pane container active">
     ...
     <!-- <div id="sliderContainer"> -->
  		...
  		<!--	<img src="img/Enterprise Architecture.png" title="Enterprise Architecture"> -->
  		<!--	<img src="img/hario2.jpg" title="Enterprise Architecture">  -->
  		<!--	<img src="img/hario.jpg" title="Enterprise Architecture"> -->
  		<!--	</div> -->
	<!-- </div> -->
	 
	 <div id="slideshow">
	 	<div><img src="img/Enterprise Architecture.png" title="Enterprise Architecture"></div>
	 	<div><img src="img/hario.jpg" title="Enterprise Architecture"></div>
	 	<div><img src="img/Enterprise Architecture.png" title="Enterprise Architecture"></div>
   	 	<div><img src="img/hario2.jpg" title="Enterprise Architecture"></div>
	</div>
